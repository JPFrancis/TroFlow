//
//  JPFMyFlowTableViewController.m
//  TroFlow
//
...
#import "JPFMyFlowTableViewController.h"
#import <Parse/Parse.h>

@interface JPFMyFlowTableViewController ()

@end

@implementation JPFMyFlowTableViewController
@synthesize flowArray;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PFObject *tempObject = [flowArray objectAtIndex:indexPath.row];
...
- (void) retrieveFromParse {
    PFQuery *retrieveEvents = [PFQuery queryWithClassName:@"FlowEvents"];
    [retrieveEvents findObjectsInBackgroundWithBlock:^(NSArray *objects, NSError *error) {
        if(!error){
            flowArray = [[NSArray alloc] initWithArray:objects];
        }
